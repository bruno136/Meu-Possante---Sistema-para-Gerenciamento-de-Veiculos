...
//Conexão c/ banco de dados
			...
			$query = "INSERT INTO abastecimentos(idveiculo,odoaba,idcomb,valoraba,precoaba,litro,idposto,dataaba,cheio) VALUES('" . $idveiculo . "','" . $odoaba . "','" . $idcomb . "','" . $valoraba . "','" . $precoaba . "','" . $litro . "','" . $idposto . "','" . $dataaba . "','" . $cheio . "');";
			$resultado = $conexao->query($query);

//fechar a conexão
			$conexao->close();

			echo "<div class='center'><p>Abastecimento inserido com sucesso!</p><img src='../../img/atencao.png'/>";

			header("refresh: 2;combustivel.php?id=$idveiculo");
			?>
		</div>
	</main>
