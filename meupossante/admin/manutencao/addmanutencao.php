...
<body>
	<nav class="orange">
		<div class="nav-wrapper">
			...
			<ul class="right hide-on-med-and-down">
				<li><a href="manutencao.php?id=<?= $id ?>" class="waves-effect waves-light btn">Voltar</a></li>
			</ul>
		</div>
	</nav>
	...
	<h4 class="center-align " style="color: orange;">Dados da Manutenção (<?=$_SESSION['placa']?>)</h4>
	<div class="valign-wrapper row login-box">
		<div class="col card  z-depth-1 grey lighten-4 s12  m6 pull-m3 l4 pull-l4" >

			<form method="post"  action="processaadd.php">
				...
				<div class="card-content">
					<div class="row">
						<div class="input-field col s12">
							...
							<input required type="number" class="validate" name="odomanu" id="odomanu" />
						</div>
						<div class="col s12 input-field">
							<i class="material-icons prefix">calendar_today</i>
							<label for="datamanu"></label>
							<input type="date"  required class="validate" name="datamanu" id="datamanu" />
						</div>
						<div class="input-field col s12">
							<i class="material-icons prefix">attach_money</i>
							<label for="valormanu">Valor</label>
							<input type="number" class="validate" step="0.01" min="0.01" required name="valormanu" id="valormanu" />
						</div>
						<div class="input-field col s12">
							<i class="material-icons prefix">place</i>
							<label for="localmanu">Local </label>
							<input type="text" name="localmanu" id="localmanu" class="validate" required  />
						</div>
						<div class="input-field col s12">		
							<i class="material-icons prefix">description</i>
							<label for="descmanu">Descrição</label>
							<input type="text" name="descmanu" id="descmanu" required class="validate" />
						</div>
					</div>
				</div>
